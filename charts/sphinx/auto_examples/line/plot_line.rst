...
.. "auto_examples/line/plot_line.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_line_plot_line.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_line_plot_line.py:
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/cnangini/PROJECTS/bdit_python_utilities/charts/sphinx/example/line/plot_line.py", line 64, in <module>
        total=pandasql.read_sql(query, con)
      File "/etc/jupyterhub/.venv/lib/python3.5/site-packages/pandas/io/sql.py", line 380, in read_sql
        chunksize=chunksize)
      File "/etc/jupyterhub/.venv/lib/python3.5/site-packages/pandas/io/sql.py", line 1468, in read_query
        cursor = self.execute(*args)
      File "/etc/jupyterhub/.venv/lib/python3.5/site-packages/pandas/io/sql.py", line 1445, in execute
        raise_with_traceback(ex)
      File "/etc/jupyterhub/.venv/lib/python3.5/site-packages/pandas/compat/__init__.py", line 420, in raise_with_traceback
        raise exc.with_traceback(traceback)
      File "/etc/jupyterhub/.venv/lib/python3.5/site-packages/pandas/io/sql.py", line 1431, in execute
        cur.execute(*args)
    ...
    LINE 6: SELECT  extract(month from pickup_datetime) as mon,
                                       ^
...
.. _sphx_glr_download_auto_examples_line_plot_line.py:
